...
progress-done = Created { $created }, updated { $updated } existing sections ({ $fields } fields), skipped { $skipped } PDFs, and failed { $failed } operations.
progress-metadata-repaired = Updated { $fields } fields across { $items } existing sections.
...
dialog-metadata-match-all = Match metadata
...
dialog-metadata-find-title = Find chapter metadata in Crossref
dialog-metadata-searching = Searching…
dialog-metadata-none = No match
dialog-metadata-confidence = { $confidence }% match
dialog-metadata-review = Crossref field preview · { $confidence }% confidence · select fields to apply
